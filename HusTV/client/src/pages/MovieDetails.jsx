  ...
  return show ? (
      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto relative p-10 md:p-12 bg-black rounded-3xl border-4 border-red-600 shadow-2xl shadow-red-600/50 hover:shadow-red-600/70 hover:border-red-500 transition-all duration-500">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center flex-wrap gap-4 mt-6">
            <button className="flex items-center gap-2 px-8 py-3 text-sm bg-gray-900 hover:bg-red-900 text-white transition-all duration-300 rounded-full font-medium cursor-pointer shadow-lg hover:shadow-xl hover:scale-105 border-2 border-red-600 hover:border-red-400 hover:shadow-red-600/50 active:scale-95">
    ...
    <div className="flex items-center justify-center min-h-screen bg-black">
      <div className="flex flex-col items-center gap-4">
        <div className="w-16 h-16 border-4 border-red-600 border-t-transparent rounded-full animate-spin shadow-lg shadow-red-600/50"></div>
